...
(rule (=> (and (inv _FH_0 _FH_1 _FH_2) (and (= |_FH_0'| (bvadd _FH_0 #x0001)) (= |_FH_2'| _FH_2) (= |_FH_1'| _FH_1))) (inv |_FH_0'| |_FH_1'| |_FH_2'|)))

(rule (=> (and (inv _FH_0 _FH_1 _FH_2) (and (bvsge _FH_1 #x07d0) (distinct _FH_0 _FH_2))) fail))
