...
(rule (=> (and (inv _FH_0 _FH_1 _FH_2 _FH_3) (and (= |_FH_0'| (bvadd _FH_0 (ite true #x1 #x0))) (= |_FH_2'| (bvadd _FH_2 #x1)) (= |_FH_1'| (bvadd _FH_1 #x1)) (= |_FH_3'| (bvadd |_FH_0'| |_FH_1'|)))) (inv |_FH_0'| |_FH_1'| |_FH_2'| |_FH_3'|)))
