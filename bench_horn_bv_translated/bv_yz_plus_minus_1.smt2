...
(rule (=> (and (inv _FH_0 _FH_1 _FH_2) (and (bvult _FH_0 #x64) (= |_FH_1'| (bvadd _FH_2 #x01)) (= |_FH_0'| (bvadd _FH_0 _FH_1)) (= |_FH_2'| (bvadd _FH_1 #xff)))) (inv |_FH_0'| |_FH_1'| |_FH_2'|)))

(rule (=> (and (inv _FH_0 _FH_1 _FH_2) (bvult _FH_0 #x00)) fail))
