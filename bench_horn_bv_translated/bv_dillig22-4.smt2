...
(rule (=> (and (inv _FH_0 _FH_1 _FH_2 _FH_3) (and (= _FH_3 |_FH_3'|) (= |_FH_0'| _FH_0) (bvslt _FH_1 _FH_3) (= |_FH_1'| (bvadd _FH_1 #x1)) (= |_FH_2'| (bvadd |_FH_0'| |_FH_1'|)))) (inv |_FH_0'| |_FH_1'| |_FH_2'| |_FH_3'|)))
