...
(rule (=> (and (inv _FH_0 _FH_1 _FH_2) (and (= |_FH_0'| (bvadd _FH_0 #x0001)) (= |_FH_1'| #x0000) (= |_FH_2'| #x0000))) (inv |_FH_0'| |_FH_1'| |_FH_2'|)))

(rule (=> (and (inv _FH_0 _FH_1 _FH_2) (and (bvsle _FH_1 #x09c4) (bvsge _FH_0 #x000a))) fail))
