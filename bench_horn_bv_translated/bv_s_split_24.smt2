...
(rule (=> (and (inv _FH_0 _FH_1 _FH_2) (and (= |_FH_1'| (bvadd _FH_1 #x0003)) (= |_FH_2'| _FH_2) (= |_FH_0'| (bvadd _FH_0 #x0002)))) (inv |_FH_0'| |_FH_1'| |_FH_2'|)))

(rule (=> (and (inv _FH_0 _FH_1 _FH_2) (and (bvsgt _FH_0 #x0190) (bvslt _FH_2 #x0064))) fail))
