...
(rule (=> (and (itp _FH_0 _FH_1 _FH_2) (and (bvslt _FH_0 #x03e8) (= |_FH_0'| (bvadd _FH_0 #x0001)) (= |_FH_1'| (bvadd _FH_1 #x0001)) (= _FH_2 |_FH_2'|))) (itp |_FH_0'| |_FH_1'| |_FH_2'|)))

(rule (=> (and (itp _FH_0 _FH_1 _FH_2) (or (bvslt _FH_1 #x0003) (bvsgt _FH_1 #x03f4))) fail))
