...
(rule (=> (and (inv _FH_0 _FH_1 _FH_2) (and (= |_FH_0'| (bvadd _FH_0 #x00000001)) (= |_FH_1'| (bvadd _FH_1 #xffffffff)) (= |_FH_2'| _FH_2))) (inv |_FH_0'| |_FH_1'| |_FH_2'|)))

(rule (=> (and (inv _FH_0 _FH_1 _FH_2) (and (bvslt _FH_2 #x000446d3) (bvsge _FH_0 #x000446d3))) fail))
