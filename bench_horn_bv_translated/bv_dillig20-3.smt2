...
(rule (=> (and (itp _FH_0 _FH_1 _FH_2 _FH_3 _FH_4 _FH_5 _FH_6) (and (= _FH_5 |_FH_5'|) (= _FH_4 |_FH_4'|) (= _FH_6 |_FH_6'|) (bvslt _FH_3 _FH_6) (= |_FH_1'| _FH_1) (= |_FH_3'| (bvadd _FH_3 #x1)) (= |_FH_0'| _FH_0) (or (= |_FH_2'| _FH_2) (= |_FH_2'| _FH_3)))) (itp |_FH_0'| |_FH_1'| |_FH_2'| |_FH_3'| |_FH_4'| |_FH_5'| |_FH_6'|)))

(rule (=> (and (itp _FH_0 _FH_1 _FH_2 _FH_3 _FH_4 _FH_5 _FH_6) (and (bvsgt _FH_3 #x0) (= _FH_3 _FH_6) (bvsge _FH_2 _FH_3))) fail))
