...
(rule (=> (and (itp _FH_0 _FH_1 _FH_2 _FH_3 _FH_4 _FH_5 _FH_6) (and (= _FH_4 |_FH_4'|) (= _FH_5 |_FH_5'|) (= _FH_6 |_FH_6'|) (bvult _FH_3 _FH_6) (= |_FH_1'| (bvadd _FH_1 (ite (= _FH_5 _FH_3) #xf #x1))) (= |_FH_3'| (bvadd _FH_3 #x1)) (or (= |_FH_2'| _FH_3) (= |_FH_2'| _FH_2)) (= |_FH_0'| (bvadd _FH_0 (ite (= _FH_5 _FH_3) #x1 #xf))))) (itp |_FH_0'| |_FH_1'| |_FH_2'| |_FH_3'| |_FH_4'| |_FH_5'| |_FH_6'|)))
