...
(rule (=> (and (inv _FH_0 _FH_1 _FH_2) (and (= (bvadd _FH_0 |_FH_0'|) #x00000000) (= |_FH_1'| (bvadd _FH_1 (ite (bvugt _FH_0 #x00000000) #x00000001 #x00000000))) (= |_FH_2'| (bvadd _FH_2 (ite (bvugt _FH_0 #x00000000) #x00000000 #x00000001))))) (inv |_FH_0'| |_FH_1'| |_FH_2'|)))
